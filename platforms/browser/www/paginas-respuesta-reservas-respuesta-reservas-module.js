...
module.exports = "h4 {\n  margin-left: 2rem; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var src_app_servicios_toast_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/servicios/toast.service */ "./src/app/servicios/toast.service.ts");
...
var RespuestaReservasPage = /** @class */ (function () {
    function RespuestaReservasPage(datePipe, route, auth, bda, bdaMEsas, alert, toast) {
        var _this = this;
        ...
        this.bda.getReservas().subscribe(function (list) {
            ...
            _this.reservasAResponder.sort(function (a, b) { return Number(Date.parse(a.fecha.toString())) - Number(Date.parse(b.fecha.toString())); });
            _this.reservasConfirmadas.sort(function (a, b) { return Number(Date.parse(a.fecha.toString())) - Number(Date.parse(b.fecha.toString())); });
