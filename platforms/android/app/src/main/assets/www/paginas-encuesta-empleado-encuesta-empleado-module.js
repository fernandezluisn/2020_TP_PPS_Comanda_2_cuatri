...
var EncuestaEmpleadoPage = /** @class */ (function () {
    ...
    EncuestaEmpleadoPage.prototype.subir = function () {
        ...
        this.encuestasService.addEncuestaEmpleado(e).then(function () {
            _this.toast.confirmationToast("Se cargó la encuesta.");
            switch (_this.usuario.perfil) {
                case 'bar':
        ...
        }).catch(function (error) { _this.alertar(error); });
    };
